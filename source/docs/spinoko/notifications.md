...
![spinoko-notifications](/assets/images/spinoko/spinoko-notifications.png)

## Notification Options

All options for displaying notifications, including enabling or disabling them, can be managed in theme customizer.

![spinoko-customizer-notifications](/assets/images/spinoko/spinoko-customizer-notifications.png)
