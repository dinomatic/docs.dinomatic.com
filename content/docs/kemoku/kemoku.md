...
To use the plugin, you must be running `WordPress 6.0` or higher and `PHP 8.4` or higher. \
...
You can check out plugin demos to get ideas on how to build your own website. Here are 3 demos for you:
