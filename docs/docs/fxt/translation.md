...
FXT also includes a Strings page in the admin ([FXT Options → 💬 Strings](/docs/fxt/theme-strings)) where you can override specific labels without a translator plugin. This is handy when you only need to tweak user-facing texts.
