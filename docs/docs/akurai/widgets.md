...
Add the `Reviews List` widget to the widget area of your choice.
...
You can display up to 10 reviews.

### Single Review Widget

Add the `Single Review` widget to the widget area of your choice.
Add a widget title, adjust settings: how to display terms and conditions and whether to include the review page link, choose the review you want to display from the dropdown list and click `Save`.
