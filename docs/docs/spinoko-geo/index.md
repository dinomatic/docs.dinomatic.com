...
It's easy to get started with SpinokoGeo. Follow the documentations to install
the plugin and start using it right away.
...
You can check out Spinoko theme demos to get an idea how SpinokoGeo plugin
works. Here are 3 demos for you:

1. [Demo #1](https://demos.dinomatic.com/ottawa/spinoko-geo)
1. [Demo #2](https://demos.dinomatic.com/bangkok/spinoko-geo)

### Changelog

Find the full changelog
[here](https://dinomatic.com/plugins/spinoko-geo/changelog).
