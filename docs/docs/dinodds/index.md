...
To use the plugin, you must be running `WordPress 5.0` or higher and `PHP 8.4` or higher. Recommended `WordPress 6.9`.
...
To be able to display the latest odds feeds, your website needs to pull the data from DinoFeeds API periodically and for this you may have to set up system cron jobs.\
