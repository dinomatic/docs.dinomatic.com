...
It's easy to get started with Hello Cookie. Follow the documentations to install
the plugin and adjust the settings.
...
[here](https://dinomatic.com/plugins/hello-cookie/changelog).
